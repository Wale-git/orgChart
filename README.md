...
users never have to worry about how to align a huge of nodes in one screen of browser. The option "verticalDepth" allows users to align child nodes vertically from the given depth.
...
### Methods
I'm sure that you can grasp the key points of the methods below after you try out demo --
##### let orgchart = new OrgChart(options);
...
<table>
  ...
  <tbody>
    <tr><td>nodedropped.orgchart</td><td>draggedNode, dragZone, dropZone</td><td>The event's handler is where you can place your customized function after node drop over. For more details, please refer to <a target="_blank">example drag & drop</a>.</td></tr>
  </tbody>
</table>
